...
const Logo = () => {
  return (
    <div className="flex p-5  justify-start items-center gap-2">
      ...
      <span className="text-3xl font-semibold ">Talker</span>
    </div>
  );
};
...
const Title = ({ text }) => {
  return (
    <h6 className="uppercase tracking-widest text-natural-400 pl-10 font-light text-opacity-90 text-sm">{text}</h6>
  );
};